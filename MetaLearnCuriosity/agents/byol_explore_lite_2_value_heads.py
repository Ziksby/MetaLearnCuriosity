    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _env_step(runner_state, unused):
                ...
                pi, value, int_value = network.apply(network_state.params, encoded_last_obs)
            ...
            encoded_last_obs = online.apply(online_state.params, last_obs)
            _, last_val, last_int_val = network.apply(network_state.params, encoded_last_obs)
            ...
            def _calculate_int_gae(traj_batch, last_int_val, r_bar, r_bar_sq, c, mu_l):
                ...
                return (
                    int_advantages,
                    int_advantages + norm_traj_batch.int_value,
                    r_bar,
                    r_bar_sq,
                    c,
                    mu_l,
            ...
            int_advantages, int_targets, r_bar, r_bar_sq, c, mu_l = _calculate_int_gae(
                traj_batch, last_int_val, r_bar, r_bar_sq, c, mu_l
            )
            ...
            def _update_epoch(update_state, unused):
                def _update_minbatch(train_states, batch_info):
                    ...
                    traj_batch, advantages, targets, int_targets = batch_info
                    ...
                    def _rl_loss_fn(
                        network_params, online_params, traj_batch, gae, targets, int_targets
                    ):
                        # RERUN NETWORK
                        encoded_obs = online.apply(online_params, traj_batch.obs)
                        pi, value, int_value = network.apply(network_params, encoded_obs)
                        ...
                        return rl_total_loss, (value_loss, loss_actor, entropy, int_value_loss)
                ...
                train_states, traj_batch, advantages, targets, int_targets, rng = update_state
                rng, _rng = jax.random.split(rng)
                ...
                batch = (traj_batch, advantages, targets, int_targets)
                ...
                update_state = (train_states, traj_batch, advantages, targets, int_targets, rng)
...
if __name__ == "__main__":
    config = {
        "RUN_NAME": "byol_lite_2_val_empty",
        "SEED": 42,
        "NUM_SEEDS": 30,
        "LR": 2.5e-4,
        "NUM_ENVS": 4,
