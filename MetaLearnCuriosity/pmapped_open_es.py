...
class OpenES(Strategy):
    def __init__(
        ...
        super().__init__(popsize=popsize, num_dims=num_dims, pholder_params=pholder_params,n_devices=n_devices)
        ...
        self.tell = jax.jit(self.tell)
        self.ask=jax.jit(self.ask)
    ...
    def tell(
        ...
        def update_fitness(fitness):
            ...
            fitness = jax.lax.cond(self.maximise_fitness,
                                lambda f: -f,
                                lambda f: f,
                                fitness)
            return fitness
        ...
        def update_mean(mean):
            ...
            mean = jax.lax.cond(self.use_mean_decay,
